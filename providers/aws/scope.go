...
var serviceScope = map[string]regionScope{
	...
	"account":               scopeGlobal,
	"savingsplans":          scopeGlobal,
	"billing":               scopeGlobal,
	"invoicing":             scopeGlobal,
	"notifications":         scopeGlobal,
	"notificationscontacts": scopeGlobal,
	"budgets":               scopeGlobal,
	...
	"vpc-route-server":             scopeRegional,
	...
	"odb":                          scopeRegional,
	"networkflowmonitor":           scopeRegional,
	"timestream-query":             scopeRegional,
